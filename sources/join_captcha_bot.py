...
from tlgbotutils import (
    ...
    tlg_member_has_join_group, tlg_member_has_left_group, tlg_get_msg_topic, tlg_create_image_from_text
)
...
async def chat_member_status_change(
    ...
    if captcha_mode == "button":
        ...
        image_path = tlg_create_image_from_text((300, 200), poll_question)

        # Send Image
        await tlg_send_image(bot, chat_id, image_path)
